...
pub struct StatusBar{
    ...
    width: usize,
    position_y: usize,
    is_visible: bool, // handle too narrow terminals and prevent visual glitches
}
...
impl StatusBar{
    ...
    }// store the width and calc the new y position
    ...
    pub fn render(&mut self){
        ...
        if let Ok(size) = Terminal::size(){
            //Assemble first part of status bar
            ...
            //this ensures remainder is formatted properly to right
